...
* Солнечная система - движение кораблей по дугам
* Солнечная система - частицы за кораблем
* Солнечная система - туманности - генерация вокруг игрока
* Солнечная система - повторная генерация обломков и кораблей
...
* Солнечная система - всплывашки для кораблей вокруг
...
* ~~Бой - после выхода из боя враг не исчезает с карты (не убираем из solarObjects)~~
* ~~Бой - после выхода из боя не обновляются одноразовые вещи игрока~~
* ~~**Бой - задержки при анимации должны рассчитываться (сейчас вбиты значения)**~~
* ~~Бой - игрок может получить число атак/защит больше чем ячеек и тем самым "зависнуть"~~
...
* ~~Солнечная система - при входе добавить модальное окно "Цель игры"~~
* ~~Солнечная система - переход к бою~~
* ~~Солнечная система - обломки~~
* ~~Солнечная система - другие корабли~~
* ~~Солнечная система - кнопка центрирования камеры на игроке~~
* ~~Солнечная система - добавить экран победы при достижении N денег~~
