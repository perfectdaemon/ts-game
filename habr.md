...
Отличным костылем в такой случае получилась банальная перезагрузка страницы через упомяутый в заголовке document.location.reload(). В условиях малого размера итогового билда (менее 300 кб, включая все ресурсы) и того, что игра работает локально, скоростью перезагрузки можно пренебречь.
