...
К слову, некоторые вещи, запеченные на атласе, так и не были использованы в игре.
...
## Заключение
В заключение хотелось бы кратко обрисовать плюсы и минусы написания игр на WebGL + TypeScript.
